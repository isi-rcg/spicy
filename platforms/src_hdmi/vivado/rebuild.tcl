...
if { $list_projs eq "" } {
   create_project pynq_hdmi -part xc7z020clg400-1
}

set_property  ip_repo_paths  {../../ip ip} [current_project]
update_ip_catalog

# CHANGE DESIGN NAME HERE
variable design_name
set design_name pynq_hdmi
...
# Hierarchical cell: hdmi_in_ddc
proc create_hier_cell_hdmi_in_ddc { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hdmi_in_ddc() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I TRI_CTRL
  create_bd_pin -dir I TRI_CTRL1
  create_bd_pin -dir I TRI_IN
  create_bd_pin -dir I TRI_IN1
  create_bd_pin -dir IO TRI_INOUT_0
  create_bd_pin -dir IO TRI_INOUT_1
  create_bd_pin -dir O TRI_OUT
  create_bd_pin -dir O TRI_OUT1

  # Create instance: XIOBUF_0, and set properties
  set XIOBUF_0 [ create_bd_cell -type ip -vlnv isi.edu:ip:XIOBUF:1.0 XIOBUF_0 ]

  # Create instance: XIOBUF_1, and set properties
  set XIOBUF_1 [ create_bd_cell -type ip -vlnv isi.edu:ip:XIOBUF:1.0 XIOBUF_1 ]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins TRI_INOUT_0] [get_bd_pins XIOBUF_0/TRI_INOUT]
  connect_bd_net -net Net1 [get_bd_pins TRI_INOUT_1] [get_bd_pins XIOBUF_1/TRI_INOUT]
  connect_bd_net -net XIOBUF_0_TRI_OUT [get_bd_pins TRI_OUT] [get_bd_pins XIOBUF_0/TRI_OUT]
  connect_bd_net -net XIOBUF_1_TRI_OUT [get_bd_pins TRI_OUT1] [get_bd_pins XIOBUF_1/TRI_OUT]
  connect_bd_net -net ps7_I2C0_SCL_O [get_bd_pins TRI_IN1] [get_bd_pins XIOBUF_1/TRI_IN]
  connect_bd_net -net ps7_I2C0_SCL_T [get_bd_pins TRI_CTRL1] [get_bd_pins XIOBUF_1/TRI_CTRL]
  connect_bd_net -net ps7_I2C0_SDA_O [get_bd_pins TRI_IN] [get_bd_pins XIOBUF_0/TRI_IN]
  connect_bd_net -net ps7_I2C0_SDA_T [get_bd_pins TRI_CTRL] [get_bd_pins XIOBUF_0/TRI_CTRL]
...
proc create_hier_cell_frontend_1 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M06_AXI [get_bd_intf_pins S00_AXILite] [get_bd_intf_pins hdmi_out_hpd_video/S_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M08_AXI [get_bd_intf_pins S04_AXILite] [get_bd_intf_pins axi_dynclk/s00_axi]
...
proc create_hier_cell_frontend { parentCell nameHier } {
  ...
  # Create instance: hdmi_in_ddc
  create_hier_cell_hdmi_in_ddc $hier_obj hdmi_in_ddc
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M07_AXI [get_bd_intf_pins S00_AXILite] [get_bd_intf_pins axi_gpio_hdmiin/S_AXI]
  ...
  connect_bd_net -net Net2 [get_bd_pins TRI_INOUT_0] [get_bd_pins hdmi_in_ddc/TRI_INOUT_0]
  connect_bd_net -net Net3 [get_bd_pins TRI_INOUT_1] [get_bd_pins hdmi_in_ddc/TRI_INOUT_1]
  connect_bd_net -net RefClk_1 [get_bd_pins clk_200M] [get_bd_pins dvi2rgb_0/RefClk]
  connect_bd_net -net TRI_CTRL_1 [get_bd_pins dvi2rgb_0/DDC_SDA_T] [get_bd_pins hdmi_in_ddc/TRI_CTRL]
  ...
  connect_bd_net -net dvi2rgb_0_DDC_SCL_O [get_bd_pins dvi2rgb_0/DDC_SCL_O] [get_bd_pins hdmi_in_ddc/TRI_IN1]
  connect_bd_net -net dvi2rgb_0_DDC_SCL_T [get_bd_pins dvi2rgb_0/DDC_SCL_T] [get_bd_pins hdmi_in_ddc/TRI_CTRL1]
  connect_bd_net -net dvi2rgb_0_DDC_SDA_O [get_bd_pins dvi2rgb_0/DDC_SDA_O] [get_bd_pins hdmi_in_ddc/TRI_IN]
  ...
  connect_bd_net -net hdmi_out_ddc1_TRI_OUT [get_bd_pins dvi2rgb_0/DDC_SDA_I] [get_bd_pins hdmi_in_ddc/TRI_OUT]
  connect_bd_net -net hdmi_out_ddc1_TRI_OUT1 [get_bd_pins dvi2rgb_0/DDC_SCL_I] [get_bd_pins hdmi_in_ddc/TRI_OUT1]
...
proc create_hier_cell_hdmi_out { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M06_AXI [get_bd_intf_pins S00_AXILite] [get_bd_intf_pins frontend/S00_AXILite]
  connect_bd_intf_net -intf_net ps7_axi_periph_M08_AXI [get_bd_intf_pins S04_AXILite] [get_bd_intf_pins frontend/S04_AXILite]
  ...
  connect_bd_net -net rst_ps7_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_unpack/ap_rst_n] [get_bd_pins pixel_unpack/ap_rst_n_control]
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M07_AXI [get_bd_intf_pins S00_AXILite] [get_bd_intf_pins frontend/S00_AXILite]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_100M] [get_bd_pins frontend/clk_100M]
  connect_bd_net -net Net1 [get_bd_pins periph_resetn_clk100M] [get_bd_pins frontend/periph_resetn_clk100M]
  connect_bd_net -net Net2 [get_bd_pins TRI_INOUT_0] [get_bd_pins frontend/TRI_INOUT_0]
  connect_bd_net -net Net3 [get_bd_pins TRI_INOUT_1] [get_bd_pins frontend/TRI_INOUT_1]
  ...
  connect_bd_net -net rst_ps7_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins color_convert/ap_rst_n_control] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n_control]
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_net -net Net2 [get_bd_pins TRI_INOUT_0] [get_bd_pins hdmi_in/TRI_INOUT_0]
  connect_bd_net -net Net3 [get_bd_pins TRI_INOUT_1] [get_bd_pins hdmi_in/TRI_INOUT_1]
  ...
  connect_bd_net -net rst_ps7_100M_interconnect_aresetn [get_bd_pins ic_resetn_clk142M] [get_bd_pins axi_mem_intercon/ARESETN]
  connect_bd_net -net rst_ps7_100M_peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins hdmi_in/periph_resetn_clk142M] [get_bd_pins hdmi_out/periph_resetn_clk142M]
...
# Hierarchical cell: hdmi_out_ddc
proc create_hier_cell_hdmi_out_ddc { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hdmi_out_ddc() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set hdmi_in_ddc_scl [ create_bd_port -dir IO hdmi_in_ddc_scl ]
  set hdmi_in_ddc_sda [ create_bd_port -dir IO hdmi_in_ddc_sda ]
  set hdmi_in_hpd [ create_bd_port -dir O -from 0 -to 0 hdmi_in_hpd ]
  set hdmi_out_ddc_scl [ create_bd_port -dir IO hdmi_out_ddc_scl ]
  set hdmi_out_ddc_sda [ create_bd_port -dir IO hdmi_out_ddc_sda ]
  ...
  # Create instance: hdmi_out_ddc
  create_hier_cell_hdmi_out_ddc [current_bd_instance .] hdmi_out_ddc
  ...
  # Create instance: psr2, and set properties
  set psr2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr2 ]

  # Create instance: psr3, and set properties
  set psr3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr3 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins ps7/S_AXI_HP0] [get_bd_intf_pins video/M_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins ps7_axi_periph/M00_AXI] [get_bd_intf_pins system_interrupts/s_axi]
  connect_bd_intf_net -intf_net ps7_axi_periph_M01_AXI [get_bd_intf_pins ps7_axi_periph/M01_AXI] [get_bd_intf_pins video/S_AXI]
  connect_bd_intf_net -intf_net video_TMDS1 [get_bd_intf_ports hdmi_out] [get_bd_intf_pins video/TMDS_out]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports hdmi_in_ddc_sda] [get_bd_pins video/TRI_INOUT_0]
  connect_bd_net -net Net1 [get_bd_ports hdmi_in_ddc_scl] [get_bd_pins video/TRI_INOUT_1]
  connect_bd_net -net Net2 [get_bd_ports hdmi_out_ddc_sda] [get_bd_pins hdmi_out_ddc/TRI_INOUT_0]
  connect_bd_net -net Net3 [get_bd_ports hdmi_out_ddc_scl] [get_bd_pins hdmi_out_ddc/TRI_INOUT_1]
  connect_bd_net -net XIOBUF_0_TRI_OUT [get_bd_pins hdmi_out_ddc/TRI_OUT] [get_bd_pins ps7/I2C0_SDA_I]
  connect_bd_net -net XIOBUF_1_TRI_OUT [get_bd_pins hdmi_out_ddc/TRI_OUT1] [get_bd_pins ps7/I2C0_SCL_I]
  connect_bd_net -net axi_gpio_video_gpio_io_o [get_bd_ports hdmi_in_hpd] [get_bd_pins video/hdmi_in_hpd]
  connect_bd_net -net concat_interrupts_dout [get_bd_pins concat/dout] [get_bd_pins ps7/IRQ_F2P]
  connect_bd_net -net hdmi_out_hpd_video_gpio_io_o [get_bd_ports hdmi_out_hpd] [get_bd_pins video/hdmi_out_hpd]
  connect_bd_net -net proc_sys_reset_fclk1_interconnect_aresetn [get_bd_pins psr1/interconnect_aresetn] [get_bd_pins video/ic_resetn_clk142M]
  connect_bd_net -net proc_sys_reset_fclk1_peripheral_aresetn [get_bd_pins psr1/peripheral_aresetn] [get_bd_pins video/periph_resetn_clk142M]
  connect_bd_net -net ps7_FCLK_CLK2 [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins psr2/slowest_sync_clk] [get_bd_pins video/clk_200M]
  connect_bd_net -net ps7_FCLK_CLK3 [get_bd_pins ps7/FCLK_CLK3] [get_bd_pins psr3/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins ps7/FCLK_RESET0_N] [get_bd_pins psr0/ext_reset_in] [get_bd_pins psr1/ext_reset_in] [get_bd_pins psr2/ext_reset_in] [get_bd_pins psr3/ext_reset_in] [get_bd_pins video/system_resetn]
  connect_bd_net -net ps7_I2C0_SCL_O [get_bd_pins hdmi_out_ddc/TRI_IN1] [get_bd_pins ps7/I2C0_SCL_O]
  connect_bd_net -net ps7_I2C0_SCL_T [get_bd_pins hdmi_out_ddc/TRI_CTRL1] [get_bd_pins ps7/I2C0_SCL_T]
  connect_bd_net -net ps7_I2C0_SDA_O [get_bd_pins hdmi_out_ddc/TRI_IN] [get_bd_pins ps7/I2C0_SDA_O]
  connect_bd_net -net ps7_I2C0_SDA_T [get_bd_pins hdmi_out_ddc/TRI_CTRL] [get_bd_pins ps7/I2C0_SDA_T]
  connect_bd_net -net psr0 [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/M01_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins system_interrupts/s_axi_aclk] [get_bd_pins video/clk_100M]
  connect_bd_net -net psr1 [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/S_AXI_HP0_ACLK] [get_bd_pins psr1/slowest_sync_clk] [get_bd_pins video/clk_142M]
  connect_bd_net -net rst_ps7_fclk0_interconnect_aresetn [get_bd_pins ps7_axi_periph/ARESETN] [get_bd_pins psr0/interconnect_aresetn] [get_bd_pins video/ic_resetn_clk100M]
  connect_bd_net -net rst_ps7_fclk0_peripheral_aresetn [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/M01_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN] [get_bd_pins psr0/peripheral_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins video/periph_resetn_clk100M]
  connect_bd_net -net system_interrupts_irq [get_bd_pins concat/In0] [get_bd_pins system_interrupts/irq]
  connect_bd_net -net video_video_irq [get_bd_pins system_interrupts/intr] [get_bd_pins video/video_irq]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_out/frontend/axi_dynclk/s00_axi/reg0] SEG_axi_dynclk_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_in/frontend/axi_gpio_hdmiin/S_AXI/Reg] SEG_axi_gpio_hdmiin_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/axi_vdma/S_AXI_LITE/Reg] SEG_axi_vdma_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_in/color_convert/s_axi_AXILiteS/Reg] SEG_color_convert_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_out/color_convert/s_axi_AXILiteS/Reg] SEG_color_convert_out_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_out/frontend/hdmi_out_hpd_video/S_AXI/Reg] SEG_hdmi_out_hpd_video_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_in/pixel_pack/s_axi_AXILiteS/Reg] SEG_pixel_pack_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_out/pixel_unpack/s_axi_AXILiteS/Reg] SEG_pixel_unpack_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41800000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs system_interrupts/S_AXI/Reg] SEG_system_interrupts_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_in/frontend/vtc_in/ctrl/Reg] SEG_vtc_in_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs video/hdmi_out/frontend/vtc_out/ctrl/Reg] SEG_vtc_out_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces video/axi_vdma/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces video/axi_vdma/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_HP0_DDR_LOWOCM
