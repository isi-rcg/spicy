...
################################################################
# This is a generated script based on design: u96v1_avnet
#
...
# source u96v1_avnet_script.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./myproj/project_1.xpr> in the current w   orking folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project pynq_u96 -part xczu3eg-sbva484-1-e
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name pynq_u96
...
proc create_root_design { parentCell } {
  ...
  set_property PFM_NAME xilinx.com:xd:pynq_u96:1.0 [get_files [current_bd_design].bd]
  ...
  make_wrapper -files [get_files ./pynq_u96.srcs/sources_1/bd/pynq_u96/pynq_u96.bd] -top
  add_files -norecurse ./pynq_u96.srcs/sources_1/bd/pynq_u96/hdl/pynq_u96_wrapper.v

  generate_target all [get_files  ./pynq_u96.srcs/sources_1/bd/pynq_u96/pynq_u96.bd]

  validate_bd_design -force

  write_dsa -force ./pynq_u96.dsa
