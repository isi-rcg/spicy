...
/* enumerations from "../../../../git/gst-libs/gst/rtsp/gstrtspdefs.h" */
GType
...
gst_rtsp_version_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_VERSION_2_0, "GST_RTSP_VERSION_2_0", "2-0" },
      { 0, NULL, NULL }
    };
...
gst_rtsp_header_field_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_HDR_PIPELINED_REQUESTS, "GST_RTSP_HDR_PIPELINED_REQUESTS", "pipelined-requests" },
      { GST_RTSP_HDR_MEDIA_PROPERTIES, "GST_RTSP_HDR_MEDIA_PROPERTIES", "media-properties" },
      { GST_RTSP_HDR_SEEK_STYLE, "GST_RTSP_HDR_SEEK_STYLE", "seek-style" },
      { GST_RTSP_HDR_ACCEPT_RANGES, "GST_RTSP_HDR_ACCEPT_RANGES", "accept-ranges" },
      { GST_RTSP_HDR_FRAMES, "GST_RTSP_HDR_FRAMES", "frames" },
      { GST_RTSP_HDR_RATE_CONTROL, "GST_RTSP_HDR_RATE_CONTROL", "rate-control" },
...
/* enumerations from "../../../../git/gst-libs/gst/rtsp/gstrtspmessage.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/rtsp/gstrtsprange.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/rtsp/gstrtsptransport.h" */
GType
