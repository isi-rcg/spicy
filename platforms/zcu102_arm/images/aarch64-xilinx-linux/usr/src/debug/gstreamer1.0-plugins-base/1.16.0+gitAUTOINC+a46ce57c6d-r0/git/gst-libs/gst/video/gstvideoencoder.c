 ...
 *
 * If multiple subframes are produced for one raw frame then use this method
 * for all the subframes but the last one by filling frame->output_buffer.
 * #gst_video_encoder_finish_frame() needs to be called for the last sub-frame
