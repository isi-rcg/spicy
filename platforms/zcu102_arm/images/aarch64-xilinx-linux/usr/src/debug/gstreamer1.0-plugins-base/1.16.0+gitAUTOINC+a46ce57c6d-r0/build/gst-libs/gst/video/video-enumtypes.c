...
/* enumerations from "../../../../git/gst-libs/gst/video/colorbalance.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/navigation.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-anc.h" */
GType
gst_video_ancillary_did_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_ANCILLARY_DID_UNDEFINED, "GST_VIDEO_ANCILLARY_DID_UNDEFINED", "undefined" },
      { GST_VIDEO_ANCILLARY_DID_DELETION, "GST_VIDEO_ANCILLARY_DID_DELETION", "deletion" },
      { GST_VIDEO_ANCILLARY_DID_HANC_3G_AUDIO_DATA_FIRST, "GST_VIDEO_ANCILLARY_DID_HANC_3G_AUDIO_DATA_FIRST", "hanc-3g-audio-data-first" },
      { GST_VIDEO_ANCILLARY_DID_HANC_3G_AUDIO_DATA_LAST, "GST_VIDEO_ANCILLARY_DID_HANC_3G_AUDIO_DATA_LAST", "hanc-3g-audio-data-last" },
      { GST_VIDEO_ANCILLARY_DID_HANC_HDTV_AUDIO_DATA_FIRST, "GST_VIDEO_ANCILLARY_DID_HANC_HDTV_AUDIO_DATA_FIRST", "hanc-hdtv-audio-data-first" },
      { GST_VIDEO_ANCILLARY_DID_HANC_HDTV_AUDIO_DATA_LAST, "GST_VIDEO_ANCILLARY_DID_HANC_HDTV_AUDIO_DATA_LAST", "hanc-hdtv-audio-data-last" },
      { GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_1_FIRST, "GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_1_FIRST", "hanc-sdtv-audio-data-1-first" },
      { GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_1_LAST, "GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_1_LAST", "hanc-sdtv-audio-data-1-last" },
      { GST_VIDEO_ANCILLARY_DID_CAMERA_POSITION, "GST_VIDEO_ANCILLARY_DID_CAMERA_POSITION", "camera-position" },
      { GST_VIDEO_ANCILLARY_DID_HANC_ERROR_DETECTION, "GST_VIDEO_ANCILLARY_DID_HANC_ERROR_DETECTION", "hanc-error-detection" },
      { GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_2_FIRST, "GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_2_FIRST", "hanc-sdtv-audio-data-2-first" },
      { GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_2_LAST, "GST_VIDEO_ANCILLARY_DID_HANC_SDTV_AUDIO_DATA_2_LAST", "hanc-sdtv-audio-data-2-last" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoAncillaryDID", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_video_ancillary_di_d16_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_ANCILLARY_DID16_S334_EIA_708, "GST_VIDEO_ANCILLARY_DID16_S334_EIA_708", "s334-eia-708" },
      { GST_VIDEO_ANCILLARY_DID16_S334_EIA_608, "GST_VIDEO_ANCILLARY_DID16_S334_EIA_608", "s334-eia-608" },
      { GST_VIDEO_ANCILLARY_DID16_S2016_3_AFD_BAR, "GST_VIDEO_ANCILLARY_DID16_S2016_3_AFD_BAR", "s2016-3-afd-bar" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoAncillaryDID16", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_video_afd_value_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_AFD_UNAVAILABLE, "GST_VIDEO_AFD_UNAVAILABLE", "unavailable" },
      { GST_VIDEO_AFD_16_9_TOP_ALIGNED, "GST_VIDEO_AFD_16_9_TOP_ALIGNED", "16-9-top-aligned" },
      { GST_VIDEO_AFD_14_9_TOP_ALIGNED, "GST_VIDEO_AFD_14_9_TOP_ALIGNED", "14-9-top-aligned" },
      { GST_VIDEO_AFD_GREATER_THAN_16_9, "GST_VIDEO_AFD_GREATER_THAN_16_9", "greater-than-16-9" },
      { GST_VIDEO_AFD_4_3_FULL_16_9_FULL, "GST_VIDEO_AFD_4_3_FULL_16_9_FULL", "4-3-full-16-9-full" },
      { GST_VIDEO_AFD_4_3_FULL_4_3_PILLAR, "GST_VIDEO_AFD_4_3_FULL_4_3_PILLAR", "4-3-full-4-3-pillar" },
      { GST_VIDEO_AFD_16_9_LETTER_16_9_FULL, "GST_VIDEO_AFD_16_9_LETTER_16_9_FULL", "16-9-letter-16-9-full" },
      { GST_VIDEO_AFD_14_9_LETTER_14_9_PILLAR, "GST_VIDEO_AFD_14_9_LETTER_14_9_PILLAR", "14-9-letter-14-9-pillar" },
      { GST_VIDEO_AFD_4_3_FULL_14_9_CENTER, "GST_VIDEO_AFD_4_3_FULL_14_9_CENTER", "4-3-full-14-9-center" },
      { GST_VIDEO_AFD_16_9_LETTER_14_9_CENTER, "GST_VIDEO_AFD_16_9_LETTER_14_9_CENTER", "16-9-letter-14-9-center" },
      { GST_VIDEO_AFD_16_9_LETTER_4_3_CENTER, "GST_VIDEO_AFD_16_9_LETTER_4_3_CENTER", "16-9-letter-4-3-center" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoAFDValue", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_video_afd_spec_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_AFD_SPEC_DVB_ETSI, "GST_VIDEO_AFD_SPEC_DVB_ETSI", "dvb-etsi" },
      { GST_VIDEO_AFD_SPEC_ATSC_A53, "GST_VIDEO_AFD_SPEC_ATSC_A53", "atsc-a53" },
      { GST_VIDEO_AFD_SPEC_SMPTE_ST2016_1, "GST_VIDEO_AFD_SPEC_SMPTE_ST2016_1", "smpte-st2016-1" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoAFDSpec", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_video_caption_type_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_CAPTION_TYPE_UNKNOWN, "GST_VIDEO_CAPTION_TYPE_UNKNOWN", "unknown" },
      { GST_VIDEO_CAPTION_TYPE_CEA608_RAW, "GST_VIDEO_CAPTION_TYPE_CEA608_RAW", "cea608-raw" },
      { GST_VIDEO_CAPTION_TYPE_CEA608_S334_1A, "GST_VIDEO_CAPTION_TYPE_CEA608_S334_1A", "cea608-s334-1a" },
      { GST_VIDEO_CAPTION_TYPE_CEA708_RAW, "GST_VIDEO_CAPTION_TYPE_CEA708_RAW", "cea708-raw" },
      { GST_VIDEO_CAPTION_TYPE_CEA708_CDP, "GST_VIDEO_CAPTION_TYPE_CEA708_CDP", "cea708-cdp" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoCaptionType", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_video_vbi_parser_result_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_VBI_PARSER_RESULT_DONE, "GST_VIDEO_VBI_PARSER_RESULT_DONE", "done" },
      { GST_VIDEO_VBI_PARSER_RESULT_OK, "GST_VIDEO_VBI_PARSER_RESULT_OK", "ok" },
      { GST_VIDEO_VBI_PARSER_RESULT_ERROR, "GST_VIDEO_VBI_PARSER_RESULT_ERROR", "error" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoVBIParserResult", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}

/* enumerations from "../../../../git/gst-libs/gst/video/video-chroma.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-color.h" */
GType
...
gst_video_transfer_function_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_VIDEO_TRANSFER_BT2020_10, "GST_VIDEO_TRANSFER_BT2020_10", "bt2020-10" },
      { GST_VIDEO_TRANSFER_SMPTE2084, "GST_VIDEO_TRANSFER_SMPTE2084", "smpte2084" },
      { GST_VIDEO_TRANSFER_ARIB_STD_B67, "GST_VIDEO_TRANSFER_ARIB_STD_B67", "arib-std-b67" },
      { 0, NULL, NULL }
    };
...
gst_video_color_primaries_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_VIDEO_COLOR_PRIMARIES_SMPTEST428, "GST_VIDEO_COLOR_PRIMARIES_SMPTEST428", "smptest428" },
      { GST_VIDEO_COLOR_PRIMARIES_SMPTERP431, "GST_VIDEO_COLOR_PRIMARIES_SMPTERP431", "smpterp431" },
      { GST_VIDEO_COLOR_PRIMARIES_SMPTEEG432, "GST_VIDEO_COLOR_PRIMARIES_SMPTEEG432", "smpteeg432" },
      { GST_VIDEO_COLOR_PRIMARIES_EBU3213, "GST_VIDEO_COLOR_PRIMARIES_EBU3213", "ebu3213" },
      { 0, NULL, NULL }
    };
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-converter.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-dither.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-format.h" */
GType
gst_video_format_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_VIDEO_FORMAT_NV12_10LE40, "GST_VIDEO_FORMAT_NV12_10LE40", "nv12-10le40" },
      { GST_VIDEO_FORMAT_Y210, "GST_VIDEO_FORMAT_Y210", "y210" },
      { GST_VIDEO_FORMAT_Y410, "GST_VIDEO_FORMAT_Y410", "y410" },
      { GST_VIDEO_FORMAT_VUYA, "GST_VIDEO_FORMAT_VUYA", "vuya" },
      { GST_VIDEO_FORMAT_BGR10A2_LE, "GST_VIDEO_FORMAT_BGR10A2_LE", "bgr10a2-le" },
      { 0, NULL, NULL }
    };
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-frame.h" */
GType
gst_video_frame_flags_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GFlagsValue values[] = {
      ...
      { GST_VIDEO_FRAME_FLAG_TOP_FIELD, "GST_VIDEO_FRAME_FLAG_TOP_FIELD", "top-field" },
      { GST_VIDEO_FRAME_FLAG_ONEFIELD, "GST_VIDEO_FRAME_FLAG_ONEFIELD", "onefield" },
      { GST_VIDEO_FRAME_FLAG_BOTTOM_FIELD, "GST_VIDEO_FRAME_FLAG_BOTTOM_FIELD", "bottom-field" },
      { 0, NULL, NULL }
    };
...
gst_video_buffer_flags_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GFlagsValue values[] = {
      ...
      { GST_VIDEO_BUFFER_FLAG_TOP_FIELD, "GST_VIDEO_BUFFER_FLAG_TOP_FIELD", "top-field" },
      { GST_VIDEO_BUFFER_FLAG_ONEFIELD, "GST_VIDEO_BUFFER_FLAG_ONEFIELD", "onefield" },
      { GST_VIDEO_BUFFER_FLAG_BOTTOM_FIELD, "GST_VIDEO_BUFFER_FLAG_BOTTOM_FIELD", "bottom-field" },
      { GST_VIDEO_BUFFER_FLAG_MARKER, "GST_VIDEO_BUFFER_FLAG_MARKER", "marker" },
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-hdr.h" */
GType
gst_video_hdr_format_get_type (void)
{
  static volatile gsize g_define_type_id__volatile = 0;
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { GST_VIDEO_HDR_FORMAT_NONE, "GST_VIDEO_HDR_FORMAT_NONE", "none" },
      { GST_VIDEO_HDR_FORMAT_HDR10, "GST_VIDEO_HDR_FORMAT_HDR10", "hdr10" },
      { GST_VIDEO_HDR_FORMAT_HDR10_PLUS, "GST_VIDEO_HDR_FORMAT_HDR10_PLUS", "hdr10-plus" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_enum_register_static ("GstVideoHDRFormat", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}

/* enumerations from "../../../../git/gst-libs/gst/video/video-info.h" */
GType
gst_video_interlace_mode_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_VIDEO_INTERLACE_MODE_ALTERNATE, "GST_VIDEO_INTERLACE_MODE_ALTERNATE", "alternate" },
      { 0, NULL, NULL }
    };
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-overlay-composition.h" */
GType
gst_video_overlay_format_flags_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GFlagsValue values[] = {
      { GST_VIDEO_OVERLAY_FORMAT_FLAG_NONE, "GST_VIDEO_OVERLAY_FORMAT_FLAG_NONE", "none" },
      { GST_VIDEO_OVERLAY_FORMAT_FLAG_PREMULTIPLIED_ALPHA, "GST_VIDEO_OVERLAY_FORMAT_FLAG_PREMULTIPLIED_ALPHA", "premultiplied-alpha" },
      { GST_VIDEO_OVERLAY_FORMAT_FLAG_GLOBAL_ALPHA, "GST_VIDEO_OVERLAY_FORMAT_FLAG_GLOBAL_ALPHA", "global-alpha" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = g_flags_register_static ("GstVideoOverlayFormatFlags", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}

/* enumerations from "../../../../git/gst-libs/gst/video/video-resampler.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-scaler.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video-tile.h" */
GType
...
/* enumerations from "../../../../git/gst-libs/gst/video/video.h" */
GType
