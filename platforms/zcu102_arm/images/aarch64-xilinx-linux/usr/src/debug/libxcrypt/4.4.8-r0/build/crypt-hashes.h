/* Generated by genhashes.awk from hashes.lst.  DO NOT EDIT.  */
...
#define HASH_ALGORITHM_TABLE_ENTRIES \
  { "$2y$", 4, crypt_bcrypt_y_rn, gensalt_bcrypt_y_rn, 16 }, \
  { "$2a$", 4, crypt_bcrypt_a_rn, gensalt_bcrypt_a_rn, 16 }, \
  { "$2x$", 4, crypt_bcrypt_x_rn, gensalt_bcrypt_x_rn, 16 }, \
  { "$6$", 3, crypt_sha512crypt_rn, gensalt_sha512crypt_rn, 15 }, \
  { "$5$", 3, crypt_sha256crypt_rn, gensalt_sha256crypt_rn, 15 }, \
  { "$sha1", 5, crypt_sha1crypt_rn, gensalt_sha1crypt_rn, 20 }, \
  { "$md5", 4, crypt_sunmd5_rn, gensalt_sunmd5_rn, 8 }, \
  { "$1$", 3, crypt_md5crypt_rn, gensalt_md5crypt_rn, 9 }, \
  { "$3$", 3, crypt_nt_rn, gensalt_nt_rn, 1 }, \
  { "_", 1, crypt_bsdicrypt_rn, gensalt_bsdicrypt_rn, 3 }, \
  { "$y$", 3, crypt_yescrypt_rn, gensalt_yescrypt_rn, 16 }, \
  { "", 0, crypt_bigcrypt_rn, gensalt_bigcrypt_rn, 2 }, \
  { "$gy$", 4, crypt_gost_yescrypt_rn, gensalt_gost_yescrypt_rn, 16 }, \
  { "", 0, crypt_descrypt_rn, gensalt_descrypt_rn, 2 }, \
  { "$7$", 3, crypt_scrypt_rn, gensalt_scrypt_rn, 16 }, \
  { "$2b$", 4, crypt_bcrypt_rn, gensalt_bcrypt_rn, 16 }, \
  { 0, 0, 0, 0, 0 }

#define HASH_ALGORITHM_DEFAULT "$6$"
