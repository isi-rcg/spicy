...
/* BOOLEAN:INT (../glib-2.60.7/tests/gobject/testmarshal.list:2) */
void
...
/* STRING:INT (../glib-2.60.7/tests/gobject/testmarshal.list:3) */
void
...
/* VARIANT:POINTER (../glib-2.60.7/tests/gobject/testmarshal.list:4) */
void
