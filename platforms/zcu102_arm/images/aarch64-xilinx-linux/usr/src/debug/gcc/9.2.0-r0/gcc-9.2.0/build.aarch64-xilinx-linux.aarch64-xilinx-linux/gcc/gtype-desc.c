...
void
gt_ggc_mx_hash_map_tree_tree_tree_cache_traits_ (void *x_p)
{
  hash_map<tree,tree,tree_cache_traits> * const x = (hash_map<tree,tree,tree_cache_traits> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct tree_cache_traits& x_r ATTRIBUTE_UNUSED)
{
  struct tree_cache_traits * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_11symtab_node ((*x).free_nodes);
      gt_ggc_m_11cgraph_edge ((*x).free_edges);
...
void
gt_ggc_mx_value_range_base (void *x_p)
{
  struct value_range_base * const x = (struct value_range_base *)x_p;
  if (ggc_test_and_set_mark (x))
    {
...
void
gt_ggc_mx (struct value_range_base& x_r ATTRIBUTE_UNUSED)
{
  struct value_range_base * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_9tree_node ((*x).m_min);
  gt_ggc_m_9tree_node ((*x).m_max);
}

void
gt_ggc_mx (struct value_range_base *& x)
{
  if (x)
    gt_ggc_mx_value_range_base ((void *) x);
}
...
gt_ggc_mx (struct ipa_jump_func& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_m_16value_range_base ((*x).m_vr);
  switch ((int) (((*x)).type))
    {
    case IPA_JF_CONST:
...
void
gt_pch_nx_hash_map_tree_tree_tree_cache_traits_ (void *x_p)
{
  hash_map<tree,tree,tree_cache_traits> * const x = (hash_map<tree,tree,tree_cache_traits> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_37hash_map_tree_tree_tree_cache_traits_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct tree_cache_traits& x_r ATTRIBUTE_UNUSED)
{
  struct tree_cache_traits * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_12symbol_table))
    {
      ...
      gt_pch_n_11symtab_node ((*x).free_nodes);
      gt_pch_n_11cgraph_edge ((*x).free_edges);
...
void
gt_pch_nx_value_range_base (void *x_p)
{
  struct value_range_base * const x = (struct value_range_base *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_16value_range_base))
    {
...
void
gt_pch_nx (struct value_range_base& x_r ATTRIBUTE_UNUSED)
{
  struct value_range_base * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_9tree_node ((*x).m_min);
  gt_pch_n_9tree_node ((*x).m_max);
...
void
gt_pch_nx (struct value_range_base *& x)
{
  if (x)
    gt_pch_nx_value_range_base ((void *) x);
}
...
gt_pch_nx (struct ipa_jump_func& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_n_16value_range_base ((*x).m_vr);
  switch ((int) (((*x)).type))
    {
    case IPA_JF_CONST:
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_aarch64_override_tune_string), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_aarch64_branch_protection_string), cookie);
}
...
void
gt_pch_p_37hash_map_tree_tree_tree_cache_traits_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<tree,tree,tree_cache_traits> * x ATTRIBUTE_UNUSED = (struct hash_map<tree,tree,tree_cache_traits> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct tree_cache_traits* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).free_nodes), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).free_edges), cookie);
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_16value_range_base (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct value_range_base * x ATTRIBUTE_UNUSED = (struct value_range_base *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).m_min), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_max), cookie);
...
void
gt_pch_nx (struct value_range_base* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).m_min), cookie);
