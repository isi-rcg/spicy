...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 362,      /* -Wpoison-system-directories */
  ...
  OPT_fshort_enums = 1046,                   /* -fshort-enums */
  OPT_fshort_wchar = 1047,                   /* -fshort-wchar */
  OPT_fshow_column = 1048,                   /* -fshow-column */
  OPT_fshrink_wrap = 1049,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1050,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1051,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1052,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1053,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1054,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1055,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1056,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1057,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1058,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1059,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1060,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1061,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1062,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1063,              /* -fsplit-wide-types */
  OPT_fsquangle = 1064,                      /* -fsquangle */
  OPT_fssa_backprop = 1065,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1066,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1067,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1068,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1069, */             /* -fstack-check */
  OPT_fstack_check_ = 1070,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1071,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1072,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1073,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1074,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1075,               /* -fstack-protector */
  OPT_fstack_protector_all = 1076,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1077,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1078,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1079,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1080,                   /* -fstack-usage */
  OPT_fstats = 1081,                         /* -fstats */
  OPT_fstdarg_opt = 1082,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1083,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1084, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1085,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1086,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1087,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1088,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1089,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1090, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1091,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1092,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1093,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1094,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1095,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1096, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1097,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1098, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1099,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1100, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1101,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1102,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1103,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1104,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1105,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1106,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1107,                   /* -ftime-report */
  OPT_ftime_report_details = 1108,           /* -ftime-report-details */
  OPT_ftls_model_ = 1109,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1110,              /* -ftoplevel-reorder */
  OPT_ftracer = 1111,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1112,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1113,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1114,                   /* -ftrampolines */
  OPT_ftransition_all = 1115,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1116,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1117,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1118,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1119,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1120,              /* -ftransition=field */
  OPT_ftransition_import = 1121,             /* -ftransition=import */
  OPT_ftransition_nogc = 1122,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1123,                /* -ftransition=tls */
  OPT_ftrapping_math = 1124,                 /* -ftrapping-math */
  OPT_ftrapv = 1125,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1126,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1127,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1128,                      /* -ftree-ccp */
  OPT_ftree_ch = 1129,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1130, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1131,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1132,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1133, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1134,                   /* -ftree-cselim */
  OPT_ftree_dce = 1135,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1136,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1137,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1138,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1139,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1140, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1141,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1142,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1143, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1144,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1145,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1146, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1147,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1148,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1149,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1150,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1151,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1152,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1153,                      /* -ftree-pre */
  OPT_ftree_pta = 1154,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1155,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1156, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1157,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1158,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1159,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1160,                     /* -ftree-slsr */
  OPT_ftree_sra = 1161,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1162, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1163, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1164,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1165,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1166,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1167, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1168,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1169, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1170,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1171,         /* -funconstrained-commons */
  OPT_funderscoring = 1172,                  /* -funderscoring */
  OPT_funit_at_a_time = 1173,                /* -funit-at-a-time */
  OPT_funittest = 1174,                      /* -funittest */
  OPT_funroll_all_loops = 1175,              /* -funroll-all-loops */
  OPT_funroll_loops = 1176,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1177, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1178,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1179,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1180,                 /* -funsigned-char */
  OPT_funswitch_loops = 1181,                /* -funswitch-loops */
  OPT_funwind_tables = 1182,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1183,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1184,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1185,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1186,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1187,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1188,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1189,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1190,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1191,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1192,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1193,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1194, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1195,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1196,                   /* -fverbose-asm */
  /* OPT_fversion = 1197, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1198,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1199,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1200,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1201,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1202,                   /* -fvisibility= */
  OPT_fvpt = 1203,                           /* -fvpt */
  OPT_fvtable_gc = 1204,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1205,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1206,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1207,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1208,                     /* -fvtv-debug */
  OPT_fweak = 1209,                          /* -fweak */
  OPT_fweb = 1210,                           /* -fweb */
  /* OPT_fwhole_file = 1211, */              /* -fwhole-file */
  OPT_fwhole_program = 1212,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1213,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1214,             /* -fworking-directory */
  OPT_fwpa = 1215,                           /* -fwpa */
  OPT_fwpa_ = 1216,                          /* -fwpa= */
  OPT_fwrapv = 1217,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1218,                 /* -fwrapv-pointer */
  OPT_fxref = 1219,                          /* -fxref */
  /* OPT_fzee = 1220, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1221,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1222,                     /* -fzero-link */
  OPT_g = 1223,                              /* -g */
  OPT_gant = 1224,                           /* -gant */
  OPT_gas_loc_support = 1225,                /* -gas-loc-support */
  OPT_gas_locview_support = 1226,            /* -gas-locview-support */
  OPT_gcoff = 1227,                          /* -gcoff */
  OPT_gcoff1 = 1228,                         /* -gcoff1 */
  OPT_gcoff2 = 1229,                         /* -gcoff2 */
  OPT_gcoff3 = 1230,                         /* -gcoff3 */
  OPT_gcolumn_info = 1231,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1232,                 /* -gdescribe-dies */
  OPT_gdwarf = 1233,                         /* -gdwarf */
  OPT_gdwarf_ = 1234,                        /* -gdwarf- */
  OPT_gen_decls = 1235,                      /* -gen-decls */
  OPT_ggdb = 1236,                           /* -ggdb */
  OPT_ggnu_pubnames = 1237,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1238,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1239, /* -ginternal-reset-location-views */
  OPT_gnat = 1240,                           /* -gnat */
  OPT_gnatO = 1241,                          /* -gnatO */
  OPT_gno_ = 1242,                           /* -gno- */
  OPT_gno_pubnames = 1243,                   /* -gno-pubnames */
  OPT_gpubnames = 1244,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1245,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1246,                   /* -gsplit-dwarf */
  OPT_gstabs = 1247,                         /* -gstabs */
  OPT_gstabs_ = 1248,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1249,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1250,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1251,                        /* -gtoggle */
  OPT_gvariable_location_views = 1252,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1253,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1254,                           /* -gvms */
  OPT_gxcoff = 1255,                         /* -gxcoff */
  OPT_gxcoff_ = 1256,                        /* -gxcoff+ */
  OPT_gz = 1257,                             /* -gz */
  OPT_gz_ = 1258,                            /* -gz= */
  OPT_h = 1259,                              /* -h */
  OPT_idirafter = 1260,                      /* -idirafter */
  OPT_imacros = 1261,                        /* -imacros */
  OPT_imultiarch = 1262,                     /* -imultiarch */
  OPT_imultilib = 1263,                      /* -imultilib */
  OPT_include = 1264,                        /* -include */
  OPT_iplugindir_ = 1265,                    /* -iplugindir= */
  OPT_iprefix = 1266,                        /* -iprefix */
  OPT_iquote = 1267,                         /* -iquote */
  OPT_isysroot = 1268,                       /* -isysroot */
  OPT_isystem = 1269,                        /* -isystem */
  OPT_iwithprefix = 1270,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1271,              /* -iwithprefixbefore */
  OPT_k8 = 1272,                             /* -k8 */
  OPT_l = 1273,                              /* -l */
  OPT_lang_asm = 1274,                       /* -lang-asm */
  OPT_mabi_ = 1275,                          /* -mabi= */
  OPT_march_ = 1276,                         /* -march= */
  OPT_mbig_endian = 1277,                    /* -mbig-endian */
  OPT_mbionic = 1278,                        /* -mbionic */
  OPT_mbranch_protection_ = 1279,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1280,                       /* -mcmodel= */
  OPT_mcpu_ = 1281,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1282,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1283,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1284,             /* -mgeneral-regs-only */
  OPT_mglibc = 1285,                         /* -mglibc */
  OPT_mlittle_endian = 1286,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1287,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1288,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1289,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1290,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1291,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1292,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1293,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1294,          /* -msign-return-address= */
  ...
  OPT_mstack_protector_guard_ = 1297,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1298,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1299,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1300,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1301,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1302,             /* -mtrack-speculation */
  OPT_mtune_ = 1303,                         /* -mtune= */
  OPT_muclibc = 1304,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1305,             /* -mverbose-cost-dump */
  OPT_n = 1306,                              /* -n */
  ...
  OPT_nolibc = 1312,                         /* -nolibc */
  OPT_nophoboslib = 1313,                    /* -nophoboslib */
  OPT_nostartfiles = 1314,                   /* -nostartfiles */
  OPT_nostdinc = 1315,                       /* -nostdinc */
  OPT_nostdinc__ = 1316,                     /* -nostdinc++ */
  OPT_nostdlib = 1317,                       /* -nostdlib */
  OPT_nostdlib__ = 1318,                     /* -nostdlib++ */
  OPT_o = 1319,                              /* -o */
  OPT_p = 1320,                              /* -p */
  ...
  OPT_shared_libphobos = 1350,               /* -shared-libphobos */
  /* OPT_specs = 1351, */                    /* -specs */
  OPT_specs_ = 1352,                         /* -specs= */
  OPT_static = 1353,                         /* -static */
  OPT_static_libasan = 1354,                 /* -static-libasan */
  OPT_static_libgcc = 1355,                  /* -static-libgcc */
  OPT_static_libgfortran = 1356,             /* -static-libgfortran */
  OPT_static_libgo = 1357,                   /* -static-libgo */
  OPT_static_liblsan = 1358,                 /* -static-liblsan */
  OPT_static_libmpx = 1359,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1360,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1361,               /* -static-libphobos */
  OPT_static_libstdc__ = 1362,               /* -static-libstdc++ */
  OPT_static_libtsan = 1363,                 /* -static-libtsan */
  OPT_static_libubsan = 1364,                /* -static-libubsan */
  OPT_static_pie = 1365,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1373,                      /* -std=c++2a */
  OPT_std_c__98 = 1374,                      /* -std=c++98 */
  OPT_std_c11 = 1375,                        /* -std=c11 */
  OPT_std_c17 = 1376,                        /* -std=c17 */
  /* OPT_std_c18 = 1377, */                  /* -std=c18 */
  /* OPT_std_c1x = 1378, */                  /* -std=c1x */
  OPT_std_c2x = 1379,                        /* -std=c2x */
  /* OPT_std_c89 = 1380, */                  /* -std=c89 */
  OPT_std_c90 = 1381,                        /* -std=c90 */
  OPT_std_c99 = 1382,                        /* -std=c99 */
  /* OPT_std_c9x = 1383, */                  /* -std=c9x */
  OPT_std_f2003 = 1384,                      /* -std=f2003 */
  OPT_std_f2008 = 1385,                      /* -std=f2008 */
  OPT_std_f2008ts = 1386,                    /* -std=f2008ts */
  OPT_std_f2018 = 1387,                      /* -std=f2018 */
  OPT_std_f95 = 1388,                        /* -std=f95 */
  OPT_std_gnu = 1389,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1390, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1391, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1392,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1393,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1394,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1395, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1396, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1397,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1398,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1399,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1400,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1401, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1402, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1403,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1404, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1405,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1406,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1407, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1408, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1409,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1410, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1411, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1412, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1413, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1414, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1415,                     /* -std=legacy */
  OPT_symbolic = 1416,                       /* -symbolic */
  OPT_t = 1417,                              /* -t */
  OPT_time = 1418,                           /* -time */
  OPT_time_ = 1419,                          /* -time= */
  OPT_traditional = 1420,                    /* -traditional */
  OPT_traditional_cpp = 1421,                /* -traditional-cpp */
  OPT_trigraphs = 1422,                      /* -trigraphs */
  OPT_u = 1423,                              /* -u */
  OPT_undef = 1424,                          /* -undef */
  OPT_v = 1425,                              /* -v */
  OPT_version = 1426,                        /* -version */
  OPT_w = 1427,                              /* -w */
  OPT_wrapper = 1428,                        /* -wrapper */
  OPT_x = 1429,                              /* -x */
  OPT_z = 1430,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
