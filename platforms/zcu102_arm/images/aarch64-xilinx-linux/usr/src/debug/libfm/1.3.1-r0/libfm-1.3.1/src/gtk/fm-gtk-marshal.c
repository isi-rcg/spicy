                                               ...
                                               gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__INT_INT_UINT_UINT_POINTER) (gpointer     data1,
                                                                       ...
                                                                       gpointer     arg_5,
                                                                       gpointer     data2);
  GMarshalFunc_BOOLEAN__INT_INT_UINT_UINT_POINTER callback;
...
void
fm_marshal_VOID__OBJECT_OBJECT_POINTER (GClosure     *closure,
                                        GValue       *return_value G_GNUC_UNUSED,
                                        guint         n_param_values,
                                        const GValue *param_values,
                                        gpointer      invocation_hint G_GNUC_UNUSED,
                                        gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_OBJECT_POINTER) (gpointer     data1,
                                                            ...
                                                            gpointer     arg_3,
                                                            gpointer     data2);
  GMarshalFunc_VOID__OBJECT_OBJECT_POINTER callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
