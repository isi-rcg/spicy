...
class KeypointBoxCoder :
 ...
 public:
  ...
  inline KeypointBoxCoder* New() const final {
    return CreateMaybeMessage<KeypointBoxCoder>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_object_5fdetection_2fprotos_2fkeypoint_5fbox_5fcoder_2eproto);
    return ::descriptor_table_object_5fdetection_2fprotos_2fkeypoint_5fbox_5fcoder_2eproto.file_level_metadata[kIndexInFileMessages];
  }
