...
constexpr Target_Pool_PoolType Target_Pool_PoolType_PoolType_MAX = Target_Pool_PoolType_avg;
...
// repeated uint32 kernel_size = 1;
inline int Target_Pool_AvgLimit::kernel_size_size() const {
  return kernel_size_.size();
}
inline void Target_Pool_AvgLimit::clear_kernel_size() {
  kernel_size_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Target_Pool_AvgLimit::kernel_size(int index) const {
  // @@protoc_insertion_point(field_get:vitis.ai.Target.Pool.AvgLimit.kernel_size)
  return kernel_size_.Get(index);
}
inline void Target_Pool_AvgLimit::set_kernel_size(int index, ::PROTOBUF_NAMESPACE_ID::uint32 value) {
  kernel_size_.Set(index, value);
  // @@protoc_insertion_point(field_set:vitis.ai.Target.Pool.AvgLimit.kernel_size)
}
inline void Target_Pool_AvgLimit::add_kernel_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  kernel_size_.Add(value);
  // @@protoc_insertion_point(field_add:vitis.ai.Target.Pool.AvgLimit.kernel_size)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint32 >&
Target_Pool_AvgLimit::kernel_size() const {
  // @@protoc_insertion_point(field_list:vitis.ai.Target.Pool.AvgLimit.kernel_size)
  return kernel_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint32 >*
Target_Pool_AvgLimit::mutable_kernel_size() {
  // @@protoc_insertion_point(field_mutable_list:vitis.ai.Target.Pool.AvgLimit.kernel_size)
  return &kernel_size_;
}
