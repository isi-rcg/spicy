 ...
 */
std::string get_md5_of_file(const std::string& filepath);

/**
 * @brief Get the git commit id of xir.
 *
 * @return A string of the git commit id.
 */
std::string get_git_commit_id();

/**
 * @brief Get the xir project version information.
 *
...
/**
 * @brief Convert an xir::DataType into a string.
 *
 * @param xir::DataType.
 *
...
// op related
/**
 * @brief Convert an Op's name and type into a string.
 *
 * @param A raw pointer to the Op.
 *
 * @return A string of the name and type of the Op.
 */
