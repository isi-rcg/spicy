...
class Op {
 public:
   ...
   */
  virtual std::vector<Op*> get_input_ops() = 0;
   ...
   * @return vector of input OPs
   */
  virtual const std::vector<const Op*> get_input_ops() const = 0;
   ...
   * @return vector of input OPs
   */
  virtual void set_input_ops(std::string arg_name,
                             std::vector<Op*> op_list) = 0;
