...
TCL_CC='aarch64-xilinx-linux-gcc  -march=armv8-a+crc -mtune=cortex-a72.cortex-a53 -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security '
...
TCL_EXTRA_CFLAGS=' -O2 -pipe -g -feliminate-unused-debug-types  -pipe '
...
TCL_LD_FLAGS='-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -fstack-protector-strong -Wl,-z,relro,-z,now -Wl,--export-dynamic '
...
TCL_RANLIB='aarch64-xilinx-linux-gcc-ranlib'
...
# compiled.
TCL_SRC_DIR='/usr/include/tcl8.6.9'
...
TCL_BUILD_STUB_LIB_PATH='/usr/include/build/libtclstub8.6.a'
