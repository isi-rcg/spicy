...
# Included from asm/byteorder-64.h
...
# Included from asm/swab-64.h

# Included from asm-generic/swab.h
...
def __constant_htonl(x): return ((__be32)(__u32)(x))

def __constant_ntohl(x): return ((__u32)(__be32)(x))

def __constant_htons(x): return ((__be16)(__u16)(x))

def __constant_ntohs(x): return ((__u16)(__be16)(x))

def __constant_le64_to_cpu(x): return ___constant_swab64((__u64)(__le64)(x))

def __constant_le32_to_cpu(x): return ___constant_swab32((__u32)(__le32)(x))

def __constant_le16_to_cpu(x): return ___constant_swab16((__u16)(__le16)(x))

def __constant_cpu_to_be64(x): return ((__be64)(__u64)(x))

def __constant_be64_to_cpu(x): return ((__u64)(__be64)(x))

def __constant_cpu_to_be32(x): return ((__be32)(__u32)(x))

def __constant_be32_to_cpu(x): return ((__u32)(__be32)(x))

def __constant_cpu_to_be16(x): return ((__be16)(__u16)(x))

def __constant_be16_to_cpu(x): return ((__u16)(__be16)(x))

def __le64_to_cpu(x): return __swab64((__u64)(__le64)(x))

def __le32_to_cpu(x): return __swab32((__u32)(__le32)(x))

def __le16_to_cpu(x): return __swab16((__u16)(__le16)(x))

def __cpu_to_be64(x): return ((__be64)(__u64)(x))

def __be64_to_cpu(x): return ((__u64)(__be64)(x))

def __cpu_to_be32(x): return ((__be32)(__u32)(x))

def __be32_to_cpu(x): return ((__u32)(__be32)(x))

def __cpu_to_be16(x): return ((__be16)(__u16)(x))

def __be16_to_cpu(x): return ((__u16)(__be16)(x))
