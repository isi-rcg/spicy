...
if { $list_projs eq "" } {
   create_project pynq_bare -part xc7z020clg400-1
}


# CHANGE DESIGN NAME HERE
set design_name pynq_bare
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK0]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins ps7/FCLK_RESET0_N]
